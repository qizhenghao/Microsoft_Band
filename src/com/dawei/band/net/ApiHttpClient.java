...
public class ApiHttpClient {
    ...
    public static String getUserAgent() {
        StringBuilder ua = new StringBuilder("com.dawei.band");
        ua.append('/' + BandApplication.getContext().getPackageInfo().versionName + '_'
                +  BandApplication.getContext().getPackageInfo().versionCode);// app版本信息
        ua.append("/Android");// 手机系统平台
        ua.append("/" + android.os.Build.VERSION.RELEASE);// 手机系统版本
        ua.append("/" + android.os.Build.MODEL); // 手机型号
        ua.append("/" + BandApplication.getContext().getAppId());// 客户端唯一标识
        return ua.toString();
    }
    ...
    public static String getCookie(BandApplication appContext) {
